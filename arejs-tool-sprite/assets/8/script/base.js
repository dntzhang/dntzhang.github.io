	...
	(function() {
		...
		toolbarTop.
			...
			addItem(
              ...
              addItem('derived-vertex', 'Derived Vertex List', { active: true }).
					addItem('select-sprite', 'Select Sprite').
		...
		toolbarTop.bind('derived-vertex', function () {
		    spriteCanvasView.setTool('derived-vertex');
		});
