var ISelect = function (option) {
    ...
    function setRotateX(element, deg) {
        element.style.webkitTransform = element.style.MozTransform = element.style.msTransform = element.style.OTransform = element.style.transform = "rotateX(" + deg + "deg)";
    }

    function getRotateX(element) {
        var style = element.style, transform = style.transform || style.webkitTransform || style.mozTransform || style.msTransform || style.oTransform;
